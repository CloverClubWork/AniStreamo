...
for(let x in data){
  ...
  let htmlData = "<li class='list-group-item'><div class='vid-container'><iframe frameborder='0' allowfullscreen='' scrolling='no' allow='autoplay;fullscreen' class='video-player' src='" +string+ "'></iframe></div><h4 class='title'>"+data[x].title+"</h4></li>";
  ul.append(htmlData);
}